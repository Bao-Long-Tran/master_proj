...
//
//	Mat addRegion = imread("added_region_after.png", IMREAD_COLOR);
//
//	int width = depthMap.cols;
//	int height = depthMap.rows;
//
//	PointCloudT::Ptr depth_cloud(new PointCloudT);	//	Recovered point cloud
//	PointCloudT::Ptr add_cloud(new PointCloudT);	//	Add region cloud
//
...
//			}
//
//			else if (!((addRegion.at<Vec3b>(y, x)[2] == 255) && (addRegion.at<Vec3b>(y, x)[1] == 0) && (addRegion.at<Vec3b>(y, x)[0] == 0)))
//			{
//				newPoint.r = 255;
//				newPoint.g = 0;
//				newPoint.b = 0;
